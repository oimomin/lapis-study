    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B1120] text-app-text dark:text-app-text-dark transition-colors duration-300">
            ...
            <>
                ...
                {/* Sidebar Slide-in */}
                <div
                    className={`fixed inset-y-0 left-0 z-40 w-64 transform bg-white dark:bg-black border-r border-gray-200 dark:border-gray-800 transition-transform duration-300 ease-in-out md:hidden flex flex-col ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
                        }`}
                >
            ...
            <div className="md:pl-64 flex flex-col min-h-screen">
                ...
                <main className="flex-1 p-4 md:p-8 max-w-7xl mx-auto w-full z-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    {children}
                </main>
            </div>
        </div>
